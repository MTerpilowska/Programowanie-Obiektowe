...
public class BakteriaDobra extends Bakteria{

    BakteriaDobra() {
        this.numer_obiektu = 1;
        this.dlugosc_zycia = 26;
    }

    BakteriaDobra(BakteriaDobra bakteria_n, int x, int y){
